    ...
    <div style={{ paddingTop: '64px', minHeight: '100vh', background: 'var(--color-card)' }}>
      ...
      <div style={{
        ...
        <div className="container animate-fade-up" style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '0.9375rem', color: 'var(--color-text-secondary)', maxWidth: '400px', margin: '0 auto' }}>Tell us about your business to get personalized recommendations</p>
        </div>
      </div>
