// Document requirement mappings — single source of truth for required documents.
// Used by both the recommend and schemeGuide controllers.

const COMMON_DOCUMENTS = {
  identity: {
    name: 'Aadhaar Card',
    description: 'Government-issued 12-digit unique identity number linked to biometric data.',
    howToObtain: 'Visit nearest Aadhaar Enrolment Centre or apply online at uidai.gov.in.',
  ...
  land_records: {
    ...
    applyUrl: 'https://upbhulekh.gov.in/',
  },
  minority_cert: {
...
module.exports = { COMMON_DOCUMENTS, getRequiredDocuments };
